...
for(const kind of (['tragedy','keil','hostage','amulet'] as const).slice(0,1))test(`named anytime ${kind} preserves its paid declaration and scoped result after reload`,async({browser,request})=>{
