...
export function techniqueFor(id: string, characterName?: string, dedicated = false, variant?: TechniqueVariant): Technique | undefined {
  ...
  if (['a2-p06-r1c1','a2-p06-r1c2'].includes(id)) return { ...base, defense: 'teleport' };
  ...
  if (id === 'a2-p12-r3c2') return { ...base, school:'magic', useLevel:6, effectLevel:6, attributes:['魔','反'], counter:true, defense:'reflect', reflectMagicLimit:6, blockWarriorLimit:-1 };
