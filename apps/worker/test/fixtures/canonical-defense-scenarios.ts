...
export function makeCanonicalDefense(players:{id:string;name:string}[],mode:'S09'|'S10'){
 ...
 readySetup(()=>s,id=>act(id,{type:'PASS_SETUP'}));act(a,{type:'START_TURN'});act(a,{type:'CHOOSE_DRAW',draw:false});act(a,{type:'ATTACK',cardInstanceId:attack,targetIds:mode==='S09'?[b,c]:[b],dedicated:mode==='S09'});
