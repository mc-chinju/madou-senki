...
export class BrowserFixtureRoom extends Room {
  protected commandEntropy() {
    ...
    return (fixture?.scenario === 'lia-prayer-revival' || fixture?.scenario === 'fury-royal-reflection' || fixture?.scenario === 'shared-a09-self' || fixture?.scenario === 'canonical-lia-life') ? { ...entropy, dice: Array(100).fill(1) as number[] } : entropy;
  }
