...
| `c2-p07-r1c2-ab03#C16/no-main-action` | browser, worker-persistence | 直接assertion確認待ち（儀式後fixtureは通常行動消費済み） |
...
| `c2-p03-r1c2-ab04#C16/designated-public-state-candidates` | browser, worker-persistence | 直接assertion確認待ち |
